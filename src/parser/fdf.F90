...
module keywords
  ...
  integer                     :: num_keywords = 164 ! change this number after every adition/deletion
  ...
  type(string_t) allowed_keywords(164)       ! change this number after every adition/deletion
  ...
  subroutine allocate_keywords()
    ...
    allowed_keywords(163)%keys = 'anorm';           allowed_keywords(164)%keys = 'nstates';
