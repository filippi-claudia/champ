...
!     write(ounit,*) 'HPSI_LIN',ndim,nvec
...
!     do i=1,nparm+1
!       write(ounit,'(''SPSI_LIN'',100e12.3)')(spsi(i,ivec),ivec=1,nvec)
!     enddo
!     STOP
...
!     do i=1,nparm+i0
!       write(ounit,'(''PSI NEW'',100e12.3)')(psi(i,ivec),ivec=1,nvec)
!     enddo
