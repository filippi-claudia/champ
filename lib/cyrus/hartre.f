      subroutine hartre(y,vh,eps,h,n)
...
c     data c3,c2,c1,c0/0.125d0,-0.625d0,1.375d0,-2.875d0/
c     data d1,d2,d3/1.25d0,2.d0,-.25d0/
c     data zero,two,thrd,half/0.d0,2.d0,0.333333333333333d0,.5d0/
c     data fourpi/12.5663706143592d0/
