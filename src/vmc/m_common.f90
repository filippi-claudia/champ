!> rief File collecting all modules that replace common blocks.
!>
!> uthor P. Lopez-Tarifa & F. Zapata NLeSC(2019)
 ...
 module vmc
     ...
     integer, parameter :: MELEC = 2, MORB = 12, MBASIS = 12, MDET = 1, MCENT = 3
