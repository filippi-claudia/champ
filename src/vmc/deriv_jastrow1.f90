      ...
      contains
      subroutine deriv_jastrow1(x,fjo,d2o,fsumo,fso,fijo,d2ijo,g,go,d2g,gvalue)
! Written by Cyrus Umrigar and Claudia Filippi
      ...
      real(dp) :: fenii, feniii, fi, fi_save
      ...
      real(dp) :: term, termi, termii, termiii, termj, termjj, termu, termuu
      real(dp) :: u2mst, u2pst
...
! e-e and e-e-n terms
      ...
      rij(1)=r_ee(ij)
      if(rij(1).gt.cutjas_ee(isb,iwf)) goto 30
...
! MISSING -> derivative wrt iparmb parm = cutjas_ee
...
! There are no C terms to order 1.
   30 if(nordc.le.1) goto 58
      ...
      do ic=1,ncent
        ...
        if(ri(1).gt.cutjas_en(it,iwf) .or. rj(1).gt.cutjas_en(it,iwf)) goto 57
   ...
   65 do i=1,nelec
        ...
        do ic=1,ncent
          ...
          if(iforce_analy.eq.1) then
            ...
            feniii = feniii*term+3*fenii*termi+3*feni*termii+fen*termiii
          endif
