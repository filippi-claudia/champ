...
module keywords
  ...
  integer                     :: num_keywords = 194 ! change this number after every adition/deletion
  ...
  type(string_t) allowed_keywords(194)       ! change this number after every adition/deletion
  ...
  subroutine allocate_keywords()
    ...
    allowed_keywords(193)%keys = 'ioptbf';          allowed_keywords(194)%keys = 'ibf_opt_cutoff'
