...
module keywords
  ...
  integer                     :: num_keywords = 186 ! change this number after every adition/deletion
  ...
  type(string_t) allowed_keywords(186)       ! change this number after every adition/deletion
  ...
  subroutine allocate_keywords()
    ...
    allowed_keywords(181)%keys = 'vmc_tau';         allowed_keywords(182)%keys = 'ifragcent'
    allowed_keywords(183)%keys = 'ibranching_c';    allowed_keywords(184)%keys = 'nfrag'
    allowed_keywords(185)%keys = 'ibranching_cfrag';allowed_keywords(186)%keys = 'etrialfrag';
