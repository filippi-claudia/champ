...
! job where it left off
      ...
      if(.not.wid) then
        ...
        call mpi_send(xold_dmc,3*nelec*nwalk,mpi_double_precision,0,2,MPI_COMM_WORLD,ierr)
        call mpi_send(wt,nwalk,mpi_double_precision,0,3,MPI_COMM_WORLD,ierr)
        call mpi_send(ff(0),nfprod,mpi_double_precision,0,4,MPI_COMM_WORLD,ierr)
        ...
        call mpi_send(iage,nwalk,mpi_integer,0,10,MPI_COMM_WORLD,ierr)
        ...
        call mpi_send(xq,nquad,mpi_double_precision,0,13,MPI_COMM_WORLD,ierr)
        call mpi_send(yq,nquad,mpi_double_precision,0,14,MPI_COMM_WORLD,ierr)
        call mpi_send(zq,nquad,mpi_double_precision,0,15,MPI_COMM_WORLD,ierr)
