...
contains
! 3d grid module
! Written by Anthony Scemama
!
! Example of input:
!
! &3dgrid nstepx 30 nstepy 30 nstepz 30
! &3dgrid stepx .1 stepy .1 stepz .1
!
! The following are computed if they are not present in the input.
! &3dgrid x0 0. y0 0. z0 0.
! &3dgrid xn 1. yn 1. zn 1.
...
!      Origin and end of the grid. If not in input, compute it from the atomic
!      coordinates.
...
!      If the step is undefined, use the value in nstep3d to compute it.
!      Else, compute the value of nstep3d
