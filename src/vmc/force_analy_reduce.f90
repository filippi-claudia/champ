module force_analy_reduce_mod
      ...
      use m_force_analytic, only: wcum_block, da_psi_block, f_analy_err
        ...
        if(wid) then
          ...
          do iph=1,PTH
            do ic=1,ncent
              do k=1,3
                do ib=1,vmc_nblk
                  ii=ii+1
                  da_energy_psi_block(ib,k,ic,iph)=collect2(ii)
                enddo
              enddo
            enddo
          enddo
          ...
          do iph=1,PTH
            do ic=1,ncent
              do k=1,3
                do ib=1,vmc_nblk
                  da_energy_psi_block(ib,k,ic,iph)=0.d0
                enddo
              enddo
            enddo
          enddo
          ...
          do iph=1,PTH
            do ic=1,ncent
              do k=1,3
                do ib=1,vmc_nblk
                  ii=ii+1
                  da_psi_block(ib,k,ic,iph)=collect2(ii)
                enddo
              enddo
            enddo
          enddo
