...
contains
  ...
  subroutine generalized_eigensolver(fun_mtx_gemv, eigenvalues, ritz_vectors, nparm, nparm_max, &
       lowest, method, max_iters, tolerance, iters, max_dim_sub, fun_stx_gemv, idtask)
    ...
    integer, intent(in) :: nparm, nparm_max, lowest, idtask
    ...
    parameters = davidson_parameters(nparm, nparm_max, lowest, max_dim_sub)
