...
! If nconf_new > 0, dump configurations for a future optimization or dmc calculation.
! Figure out frequency of configuration writing to produce nconf_new configurations.
! If nconf_new = 0, then no configurations are written.
