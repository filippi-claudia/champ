      ...
      use contrldmc, only: iacc_rej,icross,icut_br,icut_e,ivmc_corr,idmc,ipq,limit_wt_dmc
        ...
        do ifr=1,nforce
          do iw=1,nwalk
            ...
            if (icut_e.eq.0) then
              ...
              ! write(ounit,'(''fratio'',f8.5)') fratio(iw,ifr)
            endif
          enddo
        enddo
        ncall=ncall+1
      ...
      do iw=1,nwalk
        ...
        do ifr=1,nforce
          ...
          if (icut_e.eq.0) then
            ...
            ! fration = 1.0d0/dsqrt(1.0d0 + (fratio_aux)**2)
            ! write(100+idtask,'(''fration'',i3,f8.5)') iw,fration
          endif            
