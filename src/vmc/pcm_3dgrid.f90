...
contains
! 3d grid module
! Created by Amovilli/Floris following subroutines by Scemama
! Example of input:
!
! &pcm nx_pcm 30 ny_pcm 30 nz_pcm 30
! &pcm dx_pcm .1 dy_pcm .1 dz_pcm .1
!
! The following are computed if they are not present in the input.
! &pcm x0_pcm 0. y0_pcm 0. z0_pcm 0.
! &pcm xn_pcm 1. yn_pcm 1. zn_pcm 1.
!----------------------------------------------------------------------
...
! Test if the input is consistent
       input_ok=1
       do i=1,3
...
! Origin and end of the grid. If not in input, compute it from the atomic coordinates.
       do i=1,3
...
! If the step is undefined, use the value in ipcm_nstep3d to compute it.
! Else, compute the value of ipcm_nstep3d
       do i=1, 3
...
! Prepare the integer->cartesian array
       do i=1,3
...
!     Print the parameters to the output file
...
!----------------------------------------------------------------------
! PCM on a 3d grid with spline fit
...
!     yz_max = 2+3+3 = 8
      ...
      iok=1
! We have no info on the derivatives, so use "not a knot" in the creation of the fit
      ibcxmin=0
      ibcxmax=0
      ibcymin=0
      ibcymax=0
...
! Calculate the value of the pcm potential on the position [r(1),r(2),r(3)]
...
! DEBUG
!      do 30 ix=1,ipcm_nstep3d(1)
!         r(1)=pcm_cart_from_int(ix,1)
!         do 30 iy=1,ipcm_nstep3d(2)
!           r(2)=pcm_cart_from_int(iy,2)
!           do 30 iz=1,ipcm_nstep3d(3)
!             r(3) =pcm_cart_from_int(iz,3)
!
!             call pcm_extpot_ene_elec(r,pepol_s,pepol_v)
!             call spline_pcm(r,value,ier)
!  30         write(ounit,*) 'DEBUG',pepol_s+pepol_v, value
!      stop
...
!......................................................
      ...
      pepol_s=0.0d0
!......................................................
!     interaction with surface point charges
!......................................................
      do j=1,nchs
        ...
        repol=dsqrt(r2)
!......................................................
!    corrections for collisions electrons-qpol
!......................................................
...
!......................................................
!     interaction with volume point charges
!......................................................
      pepol_v=0.0d0
      do j=nchs+1,nch
        xx=(x(1)-xpol(1,j))**2.0d0
