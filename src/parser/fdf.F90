...
module keywords
  ...
  integer                     :: num_keywords = 179 ! change this number after every adition/deletion
  ...
  type(string_t) allowed_keywords(179)       ! change this number after every adition/deletion
  ...
  subroutine allocate_keywords()
    ...
    allowed_keywords(179)%keys = 'deps'
