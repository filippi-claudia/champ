...
module keywords
  ...
  subroutine allocate_keywords()
    ...
    allowed_keywords(93)%keys = 'ibeta';            allowed_keywords(94)%keys = 'iapprox'
    allowed_keywords(95)%keys = 'ncore';            allowed_keywords(96)%keys = 'iuse_orbeigv'
    allowed_keywords(97)%keys = 'ioptjas';          allowed_keywords(98)%keys = 'ioptorb'
    allowed_keywords(99)%keys = 'ioptci';           allowed_keywords(100)%keys = 'no_active'
    allowed_keywords(101)%keys = 'energy_tol';      allowed_keywords(102)%keys = 'add_diag'
    allowed_keywords(103)%keys = 'dparm_norm_min';  allowed_keywords(104)%keys = 'nopt_iter'
    allowed_keywords(105)%keys = 'micro_iter_sr';   allowed_keywords(106)%keys = 'func_omega'
    allowed_keywords(107)%keys = 'omega';           allowed_keywords(108)%keys = 'n_omegaf'
    allowed_keywords(109)%keys = 'n_omegat';        allowed_keywords(110)%keys = 'lin_nvec'
    allowed_keywords(111)%keys = 'lin_nvecx';       allowed_keywords(112)%keys = 'lin_adiag'
    allowed_keywords(113)%keys = 'lin_eps';         allowed_keywords(114)%keys = 'lin_jdav'
    allowed_keywords(115)%keys = 'multiple_adiag';  allowed_keywords(116)%keys = 'sr_tau'
    allowed_keywords(117)%keys = 'sr_adiag';        allowed_keywords(118)%keys = 'sr_eps'
    allowed_keywords(119)%keys = 'ilastvmc';        allowed_keywords(120)%keys = 'dl_mom'
    allowed_keywords(121)%keys = 'dl_alg';          allowed_keywords(122)%keys = 'isample_cmat'
    allowed_keywords(123)%keys = 'ngrad_jas_blocks';allowed_keywords(124)%keys = 'iciprt'
    allowed_keywords(125)%keys = 'save_blocks';     allowed_keywords(126)%keys = 'force_blocks'
    allowed_keywords(127)%keys = 'iorbsample';      allowed_keywords(128)%keys = 'sample'
    allowed_keywords(129)%keys = 'weights_guiding'; allowed_keywords(130)%keys = 'nloc'
    allowed_keywords(131)%keys = 'zmatrix_connection';allowed_keywords(132)%keys = 'nextorb'
    allowed_keywords(133)%keys = 'trexio';          allowed_keywords(134)%keys = 'basis'
    allowed_keywords(135)%keys = 'molecule';        allowed_keywords(136)%keys = 'determinants'
    allowed_keywords(137)%keys = 'symmetry';        allowed_keywords(138)%keys = 'jastrow'
    allowed_keywords(139)%keys = 'jastrow_der';     allowed_keywords(140)%keys = 'orbitals'
    allowed_keywords(141)%keys = 'exponents';       allowed_keywords(142)%keys = 'pseudo'
    allowed_keywords(143)%keys = 'optorb_mixvirt';  allowed_keywords(144)%keys = 'forces'
    allowed_keywords(145)%keys = 'multideterminants';allowed_keywords(146)%keys = 'eigenvalues'
    allowed_keywords(147)%keys = 'basis_num_info';  allowed_keywords(148)%keys = 'dmatrix'
    allowed_keywords(149)%keys = 'cavity_spheres';  allowed_keywords(150)%keys = 'efield'
    allowed_keywords(151)%keys = 'modify_zmatrix';  allowed_keywords(152)%keys = 'weights'
    allowed_keywords(153)%keys = 'gradients_cartesian';allowed_keywords(154)%keys = 'print'
    allowed_keywords(155)%keys = 'gradients_zmatrix';allowed_keywords(156)%keys = 'nquad'
    allowed_keywords(157)%keys = 'hessian_zmatrix'; allowed_keywords(158)%keys = 'esigmatrial'
    allowed_keywords(159)%keys = 'limit_wt_dmc';    allowed_keywords(160)%keys = 'write_walkalize'
    allowed_keywords(161)%keys = 'sr_lambda';       allowed_keywords(162)%keys = 'anorm'
    allowed_keywords(163)%keys = 'lattice';         allowed_keywords(164)%keys = 'np_coul'
    allowed_keywords(165)%keys = 'np_jas';          allowed_keywords(166)%keys = 'npoly'
    allowed_keywords(167)%keys = 'cutg';            allowed_keywords(168)%keys = 'n_images'
    allowed_keywords(169)%keys = 'cutg_big';        allowed_keywords(170)%keys = 'alattice'
    allowed_keywords(171)%keys = 'iprop';           allowed_keywords(172)%keys = 'cutjas'
    allowed_keywords(173)%keys = 'nstates';         allowed_keywords(174)%keys = 'orbitals_ortho'
    allowed_keywords(175)%keys = 'dmc_ivd';         allowed_keywords(176)%keys = 'ipathak'
    allowed_keywords(177)%keys = 'eps_max';         allowed_keywords(178)%keys = 'deps'
    allowed_keywords(179)%keys = 'nwprod';          allowed_keywords(180)%keys = 'vmc_tau'
    allowed_keywords(181)%keys = 'ifragcent';       allowed_keywords(182)%keys = 'ibranching_c'
